        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Have a project in mind or want to collaborate? I'd love to hear from you!. Thank You
            </p>
          </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  position, freelance project, or just a chat about technology. 
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">festusbamikole2018@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+234 8160779706</p>
                  </div>
                </div>
